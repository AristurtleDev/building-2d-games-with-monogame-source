...
public abstract class Scene : IDisposable
{
    ...
    /// <summary>
    /// Gets the render target this scene renders too.
    /// </summary>
    ...
    {
        // Since a render target is a graphical resource, we'll generate it
    ...
    /// <summary>
    /// Generates a RenderTarget2D instance for the scene to render to.
    /// </summary>
