...
public class TextureAtlas
{
    ...
    private List<TextureRegion> _regionsByID;
    ...
    public TextureAtlas()
    {
        ...
        _regionsByID = new List<TextureRegion>();
    }
    ...
    /// <summary>
    /// Gets the region from this texture atlas at the specified index
    /// </summary>
    /// <param name="index">The index of the region to retrieve.</param>
    /// <returns>The TextureRegion at the specified index..</returns>
    public TextureRegion GetRegion(int index)
    {
        return _regionsByID[index];
    }
